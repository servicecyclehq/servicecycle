-- 20260524000000_vendor_notes_seed
-- Populates vendor notes with procurement intelligence for the static demo
-- account (seed.js vendors IDs 20-26) and upserts 7 additional vendors
-- (IBM, Oracle, VMware/Broadcom, Arctic Wolf, Palo Alto, AWS, Splunk).
-- Safe to re-run: updates and upserts are idempotent.

-- â”€â”€ Update existing seed.js vendors (IDs 20-26) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ Upsert new vendors â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
VALUES (
  ...
  'Asset-based pricing ($8-25/endpoint/month); 1,000+ endpoint deployments negotiate $8-14/endpoint/month. 60-day non-renewal notice window (vs. industry-standard 30 days) -- calendar alert is critical. Physical sensor hardware ($1,250-$22,000 per sensor) billed separately from subscription and often missed in TCO. Bundle MDR + Managed Risk + Security Awareness Training for 15-30% discount. CrowdStrike Falcon Complete and Huntress are credible competitive alternatives. Verify endpoint scope before renewal -- broad "protected assets" language can inflate billable count.',
  NOW(), NOW()
)
ON CONFLICT ("id") DO UPDATE SET
  "notes" = EXCLUDED."notes",
