...
export const TCC_LIBRARY: TccEntry[] = [
  ...
  { manufacturer: 'GE', series: 'Spectra RMS', aliases: ['spectra', 'general electric'], deviceType: 'breaker', tripUnitType: 'electronic_lsig', frameMinA: 15, frameMaxA: 1200, typicalClearingTimeMs: 16, curveRef: 'GE Spectra RMS TCC' },
