...
function drawFooter(doc: any, meta: any, pageNum: number) {
  ...
  try {
    ...
    // Right-align by computed x (a width + align:'right' flows below the margin -> blank page).
    doc.fillColor(COLORS.textSubtle).font(FONT_REG).fontSize(8);
...
function renderProposalPdf(data: any, meta: any): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    ...
    try {
      drawFooter(doc, meta, 1); // page-1 footer while page 1 is current; pageAdded covers pages 2+
