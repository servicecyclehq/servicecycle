...
| R-05 | Dependency vulnerability (npm supply-chain attack) | Security | 3 | 3 | 9 | `npm audit` run in CI; Dependabot PRs opened automatically; `tsc --noEmit` catches type-level API surface changes; Docker base image pinned to digest | 6 | Engineering | Gap: Dependabot not yet enabled — see SOC2 CC5.2 |
...
| R-05 | Enable GitHub Dependabot alerts on the servicecyclehq/servicecycle repo | Q3 2026 |
| R-05 | Add `npm audit --audit-level=high` step to GitHub Actions CI | Q3 2026 |
